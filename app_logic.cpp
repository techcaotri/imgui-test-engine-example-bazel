...
void ShowTestWindow(AppState &state) {
  ...
  ImGui::Combo("Combo", &state.combo_selection, combo_items,
...
int RunApplication(int argc, char **argv) {
  ...
  // Create window
  GLFWwindow *window =
      glfwCreateWindow(1280, 720, "ImGui Test Application", nullptr, nullptr);
  if (!window) {
  ...
  // Enable JUnit XML export
  test_io.ExportResultsFilename = "test_results/test_results.xml";
